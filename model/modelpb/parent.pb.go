...
func (*Parent) Descriptor() ([]byte, []int) {
	return fileDescriptor_fbd5c5a54f940613, []int{0}
}
...
func init() {
	proto.RegisterType((*Parent)(nil), "elastic.apm.model.Parent")
}

func init() {
	proto.RegisterFile("apm-server/model/proto/parent.proto", fileDescriptor_fbd5c5a54f940613)
}

var fileDescriptor_fbd5c5a54f940613 = []byte{
	...
	0x2f, 0xc9, 0xd7, 0x2f, 0x48, 0x2c, 0x4a, 0xcd, 0x2b, 0xd1, 0x03, 0x73, 0x84, 0x04, 0x53, 0x73,
	...
	0x4a, 0xd3, 0xc0, 0x3c, 0x88, 0x19, 0x20, 0x16, 0xc4, 0x04, 0x25, 0x05, 0x2e, 0xb6, 0x00, 0xb0,
	0x89, 0x42, 0x62, 0x5c, 0x4c, 0x99, 0x29, 0x12, 0x8c, 0x0a, 0x8c, 0x1a, 0x9c, 0x4e, 0x6c, 0x8f,
	0xee, 0xc9, 0x33, 0x79, 0xba, 0x04, 0x31, 0x65, 0xa6, 0x38, 0xb9, 0x9e, 0x78, 0x24, 0xc7, 0x78,
	0xe1, 0x91, 0x1c, 0xe3, 0x83, 0x47, 0x72, 0x8c, 0x13, 0x1e, 0xcb, 0x31, 0x5c, 0x78, 0x2c, 0xc7,
	0x70, 0xe3, 0xb1, 0x1c, 0x43, 0x94, 0x36, 0x92, 0x55, 0x50, 0x87, 0xe8, 0x63, 0xb8, 0x1a, 0x4c,
	0x16, 0x24, 0x25, 0xb1, 0x81, 0xed, 0x33, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0xe2, 0xad, 0x96,
	0x3f, 0xd8, 0x00, 0x00, 0x00,
}
...
func (m *Parent) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.ID) > 0 {
		i -= len(m.ID)
		copy(dAtA[i:], m.ID)
		i = encodeVarintParent(dAtA, i, uint64(len(m.ID)))
		i--
		dAtA[i] = 0xa
	}
