...
func (*Child) Descriptor() ([]byte, []int) {
	return fileDescriptor_edbf3ab2abf8ecf1, []int{0}
}
...
func init() {
	proto.RegisterType((*Child)(nil), "elastic.apm.model.Child")
}

func init() {
	proto.RegisterFile("apm-server/model/proto/child.proto", fileDescriptor_edbf3ab2abf8ecf1)
}

var fileDescriptor_edbf3ab2abf8ecf1 = []byte{
	...
	0x2f, 0xc9, 0xd7, 0x4f, 0xce, 0xc8, 0xcc, 0x49, 0xd1, 0x03, 0xb3, 0x85, 0x04, 0x53, 0x73, 0x12,
	...
	0xd3, 0xc0, 0x3c, 0x88, 0x11, 0x20, 0x16, 0xc4, 0x04, 0x25, 0x79, 0x2e, 0x56, 0x67, 0x90, 0x81,
	0x42, 0x62, 0x5c, 0x4c, 0x99, 0x29, 0x12, 0x8c, 0x0a, 0xcc, 0x1a, 0x9c, 0x4e, 0x6c, 0x8f, 0xee,
	0xc9, 0x33, 0x79, 0xba, 0x04, 0x31, 0x65, 0xa6, 0x38, 0xb9, 0x9e, 0x78, 0x24, 0xc7, 0x78, 0xe1,
	0x91, 0x1c, 0xe3, 0x83, 0x47, 0x72, 0x8c, 0x13, 0x1e, 0xcb, 0x31, 0x5c, 0x78, 0x2c, 0xc7, 0x70,
	0xe3, 0xb1, 0x1c, 0x43, 0x94, 0x36, 0x92, 0x4d, 0x50, 0x77, 0xe8, 0x63, 0xb8, 0x19, 0x4c, 0x16,
	0x24, 0x25, 0xb1, 0x81, 0xad, 0x33, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x86, 0x5d, 0xa9, 0xf5,
	0xd6, 0x00, 0x00, 0x00,
}
...
func (m *Child) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ID) > 0 {
		for iNdEx := len(m.ID) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintChild(dAtA, i, uint64(len(m.ID[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
