...
func (m *HTTPRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Cookies) > 0 {
		for iNdEx := len(m.Cookies) - 1; iNdEx >= 0; iNdEx-- {
			if marshalto, ok := interface{}(m.Cookies[iNdEx]).(interface {
				MarshalToSizedBufferVT([]byte) (int, error)
			}); ok {
				size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
				if err != nil {
				...
				encoded, err := proto.Marshal(m.Cookies[iNdEx])
				if err != nil {
					return 0, err
				}
				i -= len(encoded)
...
func (m *HTTPRequestBody) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *HTTPRequestBody) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *HTTPRequestBody) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *HTTPResponseBody) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *HTTPResponseBody) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *HTTPResponseBody) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if m.DecodedBytes != 0 {
		i = encodeVarint(dAtA, i, uint64(m.DecodedBytes))
		i--
		dAtA[i] = 0x18
	}
	if m.Bytes != 0 {
...
func (m *HTTPRequestBody) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *HTTPResponseBody) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *HTTPRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.Cookies = append(m.Cookies, &structpb.Struct{})
			if unmarshal, ok := interface{}(m.Cookies[len(m.Cookies)-1]).(interface {
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.Cookies[len(m.Cookies)-1]); err != nil {
					return err
				}
			}
			iNdEx = postIndex
...
func (m *HTTPRequestBody) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *HTTPResponseBody) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
