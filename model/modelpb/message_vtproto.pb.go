...
func (m *Message) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Age != nil {
		if marshalto, ok := interface{}(m.Age).(interface {
			...
			encoded, err := proto.Marshal(m.Age)
			if err != nil {
				return 0, err
			}
			i -= len(encoded)
...
func (m *MessageQueue) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *MessageQueue) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *MessageQueue) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *Message) SizeVT() (n int) {
	...
	if m.Age != nil {
		if size, ok := interface{}(m.Age).(interface {
			SizeVT() int
		}); ok {
			l = size.SizeVT()
		} else {
...
func (m *MessageQueue) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Message) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.Age == nil {
				m.Age = &durationpb.Duration{}
			}
			if unmarshal, ok := interface{}(m.Age).(interface {
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.Age); err != nil {
					return err
				}
			}
			iNdEx = postIndex
...
func (m *MessageQueue) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
