...
type ServerParams struct {
	...
	// Logger is the logger for the apmserver component.
	Logger *logp.Logger
	...
	// See package internal/apmserver/interceptors for details.
